<template>
  <div class="space-y-6">
    ...
    <div class="p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm space-y-2 transition-colors">
      <p class="text-[10px] font-mono font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">Fase 2 — Pekerjaan Gudang • Checkpoint: DEBULKING → DEBULKING_COMPLETED</p>
